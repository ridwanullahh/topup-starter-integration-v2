...
function DeleteAccountModal({ showDeleteAccountModal, setShowDeleteAccountModal }: { showDeleteAccountModal: boolean; setShowDeleteAccountModal: Dispatch<SetStateAction<boolean>> }) {
      ...
      <form
        ...
        <div>
          <label
            ...
            To verify, type <span className="font-semibold text-black dark:text-white">confirm delete account</span> below
          </label>
          <Input
            type="text"
            name="verification"
